...
# Merge biomass and N% data of maize and wheat experiments
...
wheat_bio_work <- wheat_bio_raw %>%
  dplyr::select(HarvestDate,Plot,
                ...
                LeafYield_kgPerHa:ChaffYield_kgPerHa) %>%
  ...
  dplyr::select(HarvestDate, Plot,Block, WaterTreat, NitroTreat,LeafYield_kgPerHa:ChaffYield_kgPerHa) %>%
   tidyr::gather("Organ","BiomassWeight",LeafYield_kgPerHa:ChaffYield_kgPerHa) %>%
    mutate(Organ = factor(Organ, levels=c("LeafYield_kgPerHa",	
                                          "StemYield_kgPerHa",	
                                          "DeadYield_kgPerHa",	
                                          "EarYield_kgPerHa",	
                                          "GrainYield_kgPerHa",	
